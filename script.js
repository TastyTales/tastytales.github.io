...
predTest.addEventListener('click', function () {
  readTextFile("data/pred.json", (text) => {
    ...
    console.log(JSON.stringify(predStatements, null, 2));
  });
});

wpreyTest.addEventListener('click', function () {
  readTextFile("data/wprey.json", (text) => {
    let j = JSON.parse(text)
    wpreyStatements = j
    ...
    console.log(JSON.stringify(wpreyStatements, null, 2));
  });
});

upreyTest.addEventListener('click', function () {
  readTextFile("data/uprey.json", (text) => {
    let j = JSON.parse(text)
    upreyStatements = j
    ...
    console.log(JSON.stringify(upreyStatements, null, 2));
  });
});
